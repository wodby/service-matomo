# PHP (Matomo 5) service for Wodby

Use PHP (Matomo 5) as a reusable component in applications managed by Wodby.
This repository contains the service manifests and referenced files used by the
public PHP (Matomo 5) service in the Wodby catalog.

- [PHP (Matomo 5) service in the Wodby catalog](https://wodby.com/services/matomo)
...
4. Reference `matomo` from your stack manifest.
